...
CREATE TABLE `inventory` (
  ...
  `stockInWarehouse` int DEFAULT NULL,
  `stockStatus` enum('O','L','F') DEFAULT NULL,
  `Inventorycol` varchar(45) DEFAULT NULL,
  `type` enum('F','B','T','H','M') DEFAULT NULL,
...
CREATE TABLE `sales` (
  ...
  `itemBought` varchar(45) DEFAULT NULL,
  `quantity` int DEFAULT NULL,
  `additionalTaxes` double DEFAULT NULL,
  `damgesOrLosses` double DEFAULT NULL,
...
-- Dump completed on 2024-11-17 20:19:00
